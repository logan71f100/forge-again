...
window.ForgeCanvas = class extends window.ForgeCanvas {
    ...
    on_img_upload() {
        ...
        this._forgeUploadCanvasPNG(tc)
            .then(p => this.background_gradio_bind.set_value('forge-file:' + p))
            .catch(e => { console.warn('[forge-canvas] file upload failed, falling back to base64:', e); super.on_img_upload(); });
    }
