...
// So the toggle wraps handleDraw and forces the erase branch by temporarily
// clearing both gates. Wrapping the GLOBAL class covers both construction
// paths: eager canvases (root_block.load 'new ForgeCanvas(...)') and lazy
// ones (canvas_lazy_init.js) all resolve ForgeCanvas via window.
