...
// handleDraw already erases (globalCompositeOperation 'destination-out')
// whenever scribbleAlpha == 0; the toggle just parks alpha at 0 and restores
// it after. Wrapping the GLOBAL class covers both construction paths: eager
// canvases (root_block.load 'new ForgeCanvas(...)') and lazy ones
// (canvas_lazy_init.js) all resolve ForgeCanvas via window.
window.ForgeCanvas = class extends window.ForgeCanvas {
    constructor(...args) {
        ...
        try {
            ...
            this._eraser_saved_alpha = null;
            btn.addEventListener('click', () => {
                this.eraser_mode = !this.eraser_mode;
                btn.classList.toggle('forge-btn-active', this.eraser_mode);
                if (this.eraser_mode) {
                    this._eraser_saved_alpha = this.scribbleAlpha;
                    this.scribbleAlpha = 0;
                } else if (this._eraser_saved_alpha !== null) {
                    this.scribbleAlpha = this._eraser_saved_alpha;
                    this._eraser_saved_alpha = null;
                }
            });
        } catch (e) {
