...
def prepareExpectedUIBehavior(gArgs: GenerationArgs):
    ...
    # gradio 6 passes None for empty textboxes (gradio 4 passed '')
    gArgs.detectionPrompt = (gArgs.detectionPrompt or '').strip()
    gArgs.avoidancePrompt = (gArgs.avoidancePrompt or '').strip()
