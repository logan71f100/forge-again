...
onAfterUiUpdate(function() {
    // first selector pair: gradio 4 gallery DOM; second: gradio 6 (.gallery-container >
    // span.preview > button.media-button > img). Keep both so either version binds.
    var fullImg_preview = gradioApp().querySelectorAll('.gradio-gallery > button > button > img, .gradio-gallery .preview > button.media-button > img, .gradio-gallery > .livePreview, .gradio-gallery .livePreview');
