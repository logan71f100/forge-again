...
def webpath(fn):
    # gradio 6 serves allowed static files at /gradio_api/file= (gradio 4 used /file=).
    # Without the prefix every injected <script>/<link> 404s -- which kills ALL of the
    # webui's frontend JS (submit, progress bar, extra networks, shortcuts, ...).
