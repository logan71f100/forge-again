...
class Api:
    ...
    def init_default_script_args(self, script_runner):
        ...
        # LAZY TABS: scripts belonging to a lazily-built tab (img2img) have
        # args_from/args_to = None until that tab's UI is first opened -- skip them
        # here instead of crashing ('<' not supported between int and NoneType).
        last_arg_index = 1
        ...
        with gr.Blocks(): # will throw errors calling ui function without this
            for script in script_runner.scripts:
                if script.args_from is None or script.args_to is None:
                    continue
