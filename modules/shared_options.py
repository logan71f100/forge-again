...
options_templates.update(options_section(('img2img', "img2img", "sd"), {
    "forge_kontext_reference_edit": OptionInfo("Auto", "Kontext reference edit: use the img2img init image as an instruction-editing reference", gr.Radio, {"choices": ["Auto", "On", "Off"]}, infotext='Kontext reference').info("Auto = active when the loaded checkpoint's filename contains 'kontext'. Prompt = the edit instruction; set denoising to 1.0. Add to Quicksettings for one-click access"),
