...
parser.add_argument("--enable-training", action='store_true', help="enable the OneTrainer-backed Train tab; on first launch it downloads and installs OneTrainer into extensions/forge-onetrainer/OneTrainer")
